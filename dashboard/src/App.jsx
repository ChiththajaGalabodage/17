    ...
    <div className="app-shell">
      <header className="hero">
        <div>
          ...
          <p>
            Generated tests, predictive selection, self-healing attempts, and
            live run status in one place.
          </p>
        </div>
        <div className="hero-card">
          ...
          <div className="hero-value">
            {loading ? (
              ...
              <StatusPill passed={Boolean(metrics.passed)} />
            )}
          </div>
          ...
          <div className="hero-meta">
            Live run status: {runState?.message ?? "Idle"}
          </div>
        </div>
      </header>
      ...
      <main className="grid">
        <Section
          title="Run Summary"
          subtitle="Latest pipeline snapshot from report.json."
        >
          <div className="stats">
            <div className="stat">
              <span>Functions</span>
        ...
        <Section
          title="Predictive Selection"
          subtitle="What the agent chose to run."
        >
        ...
        <Section
          title="Job Details"
          subtitle="Dashboard-triggered run diagnostics."
        >
          <div className="detail-list">
            <div>
              <span>Started</span>
        ...
        <Section
          ...
          subtitle="Recorded stage-by-stage events."
        >
        ...
        <Section
          title="Pytest Output"
          subtitle="Latest runner output from the pipeline."
        >
          <pre className="code-block">
            {runState?.output || testRun.output || "No output yet."}
          </pre>
        </Section>
        ...
        <Section
          title="Healing Details"
          subtitle="What happened during self-healing."
        >
          <pre className="code-block">
            {JSON.stringify(report?.heal_history ?? [], null, 2)}
          </pre>
        </Section>
      </main>

      <footer className="footer">
        Report timestamp: {report?.timestamp_utc ?? "n/a"}
      </footer>
    </div>
  );
}
